<template>
    <div class="flex flex-col w-64 space-y-6 px-4 py-8 bg-cyan-600 border-r dark:bg-gray-900 dark:border-gray-700">
        <div class="flex items-center space-x-2 py-4">
            ...
            <h2 class="text-2xl font-semibold text-white dark:text-white">Warung Tepat</h2>
        </div>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                <a class="flex items-center px-4 py-2 text-white rounded-md text-white transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                    href="#">
                ...
                <router-link to="/all-product"
                    :class="routeName == 'allproduct' ? 'flex items-center px-4 py-2 mt-5 text-white transition-colors duration-300 transform bg-cyan-700 rounded my-2 hover:text-cyan-300' : 'flex items-center px-4 py-2 mt-5 text-white transition-colors duration-300 transform rounded my-2 hover:text-cyan-300'">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-white transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                    ...
                    <span class="mx-4 font-medium">Transaction</span>
                </a>
